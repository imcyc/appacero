...
const ThreeScene = () => {
  ...
  useEffect(() => {
    ...
    // Crear y agregar líneas curvas repetidas
    const curvedLinesverdes2 = Array.from({ length: 3 }, (_, i) => {
      ...
      // Crear línea con Line2
      const line = new Line2(lineGeometry, lineMaterial);
      line.position.y = -1.4 + i * 1.6; // Ajustar la posición en el eje Y para cada línea
      line.position.z = 0; // Ajustar la posición en el eje Z para cada línea
      return line;
    });
