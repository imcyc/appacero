...
const ThreeScene = () => {
  ...
  useEffect(() => {
    ...
    const EstribosMorados = [
      ...
      new THREE.Vector3(-2, 0.25, 3.4),
      new THREE.Vector3(-2.3, 0.25, 3.5),
      new THREE.Vector3(-2.3, 0.225, 2),
      new THREE.Vector3(-2.3, 0.2, 1),
      new THREE.Vector3(-2.3, 0.175, 0),
      new THREE.Vector3(-2.3, 0.15, -2),
      new THREE.Vector3(-2.3, 0.125, -3),
      new THREE.Vector3(-2.3, 0.1, -3.3),
      new THREE.Vector3(-2.2, 0.075, -3.3),
      new THREE.Vector3(-1, 0.05, -3.3),
      new THREE.Vector3(0, 0.025, -3.3),
      new THREE.Vector3(3, 0, -3.3),
      new THREE.Vector3(4, 0, -3.3),
      new THREE.Vector3(5, 0, -3.3),
      new THREE.Vector3(9, 0, -3.3),
      new THREE.Vector3(9.1, 0, -3.3),
      new THREE.Vector3(9.2, 0, -3.3),
      new THREE.Vector3(9.2, 0, -3),
      new THREE.Vector3(9.2, 0, 3),
      new THREE.Vector3(9.2, 0, 3.1),
      new THREE.Vector3(9.2, 0, 3.3),
      new THREE.Vector3(9, 0, 3.4),
      new THREE.Vector3(7, 0, 3.4),
      new THREE.Vector3(6.1, 0, 3.4),
      new THREE.Vector3(6, 0, 3.4),
      new THREE.Vector3(-1, 0, 3.4),
      new THREE.Vector3(-2, 0, 3.4),
      new THREE.Vector3(-2.05, 0, 3.4),
    ...
    const EstribosMorados2 = [
      ...
      new THREE.Vector3(-2.3, 0, 3.5),
      new THREE.Vector3(-2.3, 0, 2),
      new THREE.Vector3(-2.3, 0, 1),
      new THREE.Vector3(-2.3, 0, 0),
      new THREE.Vector3(-2.3, 0, -2),
      new THREE.Vector3(-2.3, 0, -3),
      new THREE.Vector3(-2.3, 0, -3.3),

      new THREE.Vector3(-2.2, 0, -3.3),
      new THREE.Vector3(-1, 0.05, -3.3),
      new THREE.Vector3(0, 0.1, -3.3),
      new THREE.Vector3(3, 0.15, -3.3),
      new THREE.Vector3(4, 0.2, -3.3),
      new THREE.Vector3(5, 0.25, -3.3),
      new THREE.Vector3(9, 0.3, -3.3),
      new THREE.Vector3(9.1, 0.35, -3.3),
      new THREE.Vector3(9.2, 0.4, -3.3),
      new THREE.Vector3(9.3, 0.45, -3),
      new THREE.Vector3(9.3, 0.45, -2.8),
      new THREE.Vector3(7.6, 0.45, -1.2),
    ];
