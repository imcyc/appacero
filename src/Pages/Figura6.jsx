...
const ThreeScene = () => {
  ...
  useEffect(() => {
    ...
    const Grapas = [
      ...
      new THREE.Vector3(-0.55, 0.6, -0.6),
      new THREE.Vector3(-0.55, 0.6, -0.5),
      new THREE.Vector3(-0.55, 0.6, 0),
      new THREE.Vector3(-0.55, 0.6, 0.5),
      new THREE.Vector3(-0.55, 0.6, 1.5),
      new THREE.Vector3(-0.55, 0.6, 1.6),
      new THREE.Vector3(-0.5, 0.6, 1.6),
      new THREE.Vector3(-0.3, 0.6, 1.3),
    ];
    for (let i = 0; i < 3; i++) {
      createMeshLineVarillas2(Grapas, 0x39ff14, 0, 0.5, i * 1 - 1, 0);
    }
